...
Socket socket1=ss.accept();
				...
				System.out.println("Server is connecting to the client.");
...
DataInputStream dis=new DataInputStream(socket1.getInputStream());
				...
				dos.writeUTF("Hello this is line 44 of server");
...
System.out.println("There has been a SocketTimeoutException.");
b=false;
		}
